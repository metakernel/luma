<#
.SYNOPSIS
  Recursively rename LUMA/LUMBA paths and optionally update text references to LYMA/LYBA.
...
.EXAMPLES
  # Preview recursively
  .\rename-luma-lumba-to-lyma-lyba-recursive.ps1 -Root .

  # Apply recursive path renames
  .\rename-luma-lumba-to-lyma-lyba-recursive.ps1 -Root . -Apply

  # Apply recursive path renames and recursive content updates
  .\rename-luma-lumba-to-lyma-lyba-recursive.ps1 -Root . -Apply -UpdateContent

  # Also rename the root folder itself if its name contains luma/lumba
  .\rename-luma-lumba-to-lyma-lyba-recursive.ps1 -Root . -Apply -RenameRoot
#>
...
# Order matters: lumba must be replaced before luma.
$NameRules = @(
    @{ From = "LUMBA"; To = "LYBA" },
    @{ From = "Lumba"; To = "Lyba" },
    @{ From = "lumba"; To = "lyba" },
...
$ContentRules = @(
    @{ From = "Lua Unified Model Binary Assembly"; To = "Lua YAML-like Binary Assembly" },
    @{ From = "Lua Unified Model Assembly";        To = "Lua YAML-like Markup Assembly" },
    @{ From = "Lua Unified Model Binary";          To = "Lua YAML-like Binary Assembly" }
) + $NameRules
