...
use lyma_syntax::{
    ...
    LuaPreludeDirective, LymaProfile, MetaDirective, ProfileDirective, SchemaDirective, Span,
...
pub(crate) fn parse_directive_line(
    ...
    match name_text {
        "lyma" => Some(DirectiveParse::Regular(Directive::Version(
            VersionDirective {
        ...
        "profile" => Some(DirectiveParse::Regular(Directive::Profile(
            ProfileDirective {
                profile: match tail {
                    "data" => LymaProfile::Data,
                    "safe" => LymaProfile::Safe,
                    "trusted" => LymaProfile::Trusted,
                    other => LymaProfile::Custom(other.to_owned()),
                },
                name_span,
                span,
            },
...
pub(crate) fn make_lua_prelude(source: String, span: Span) -> Directive {
    Directive::LuaPrelude(LuaPreludeDirective {
        block: block_expression(
            ...
            span.end,
            span.file_id,
            lyma_syntax::BlockKind::LuaChunk,
            lyma_syntax::BlockChomping::Clip,
        ),
...
pub(crate) fn make_meta(value: lyma_syntax::MappingBlock, span: Span) -> Directive {
