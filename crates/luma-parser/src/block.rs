...
use luma_syntax::{
    BlockChomping, BlockKind, Diagnostic, DiagnosticCode, FileId, LumaNode, Span, StringNode,
    StringStyle,
};
...
pub(crate) fn parse_block_node(
    ...
    let node = match kind {
        BlockKind::Literal | BlockKind::Folded => LumaNode::String(StringNode {
            value: body.clone(),
            source: body,
        ...
        BlockKind::LuaExpression => LumaNode::LuaExpressionBlock(block_expression(
            body,
            span.start,
            span.end,
            source.source.id,
        ...
        BlockKind::LuaChunk => LumaNode::LuaChunk(block_expression(
            body,
            span.start,
            span.end,
            source.source.id,
