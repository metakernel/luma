...
use lyma_lyba::diagnostic::{DiagnosticRecord, DiagnosticTable, StoredDiagnosticSeverity};
use lyma_lyba::section::SectionEntry;
use lyma_lyba::source::{SourceFileRecord, SourceFileTable, SourceSpanRecord, SourceSpanTable};
use lyma_lyba::syntax::{SyntaxField, SyntaxFieldValue, SyntaxNodeRecord, SyntaxNodeTable};
use lyma_lyba::trivia::{TRIVIA_KIND_COMMENT, TriviaRecord, TriviaTable};
use lyma_lyba::{
    BlobRecord, BlobTable, CanonicalMode, Document, LybaFile, Value, WriteOptions, Writer,
    WriterMode,
};
...
fn syntax_fixture(with_blob: bool) -> LybaFile {
        ...
        .with_source_file_table(
            SourceFileTable::new().with_record(
                SourceFileRecord::new()
                    .with_uri(Some(String::from("mem://fixture.lyma")))
                    .with_display(Some(String::from("fixture.lyma"))),
            ),
        )
