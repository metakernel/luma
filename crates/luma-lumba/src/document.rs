...
fn invalid_document_record(record_index: usize, message: impl Into<String>) -> LumbaError {
    LumbaError::InvalidDocumentTable(ErrorContext::new(message).with_record_index(record_index))
}

fn invalid_document_table(message: impl Into<String>) -> LumbaError {
    LumbaError::InvalidDocumentTable(ErrorContext::new(message))
}

fn invalid_value_reference(record_index: usize, message: impl Into<String>) -> LumbaError {
    LumbaError::InvalidValueReference(ErrorContext::new(message).with_record_index(record_index))
}

fn invalid_syntax_reference(record_index: usize, message: impl Into<String>) -> LumbaError {
