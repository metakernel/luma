...
use luma_lumba::policy::ReservedFlagPolicy;
use luma_lumba::section::SectionId;
use luma_lumba::{
    ...
    TRIVIA_KIND_WHITESPACE, TriviaRecord, TriviaTable, WriteOptions, Writer, to_lumba_value_image,
};
...
fn canonical_value_images_omit_triv_section() {
    let bytes = to_lumba_value_image(&[LumaValue::String(String::from("portable"))]);
