...
use luma_lumba::{
    ...
    ExtensionDeclaration, ExtensionTable, ExtensionValue, Limits, LuaChunkValue, LumbaError,
    LumbaFile, MapEntry, ReadOptions, Reader, RuntimeDescriptorValue, Value, WriteOptions, Writer,
};
...
fn fixture_file(root_value: Value) -> LumbaFile {
